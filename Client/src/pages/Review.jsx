        ...
        return (
          ...
          >
            <div className="bg-[#1a1a1a] rounded-2xl border border-gray-800 overflow-hidden">
              <div className="flex flex-col gap-4 px-4 py-4 border-b border-gray-800 md:flex-row md:items-center md:justify-between md:px-6">
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 md:flex">
                  <button
                    ...
                    className="w-full px-4 py-2 text-sm rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-300 transition-colors flex items-center justify-center gap-2 md:w-auto"
                  >
        ...
        return (
          ...
          >
            <div className="bg-[#1a1a1a] rounded-2xl border border-gray-800 overflow-hidden shadow-lg">
              <div className="px-4 py-4 border-b border-gray-800 md:px-6">
                <h2 className="text-base font-semibold flex items-center gap-2">
              ...
              <div className="p-4 md:p-6">
                <div className="flex flex-col items-center justify-center w-full">
                  <label className="flex flex-col items-center justify-center w-full py-6 md:py-8 border-2 border-gray-700 border-dashed rounded-lg cursor-pointer hover:bg-[#141414] transition-colors group">
                    <div className="flex flex-col items-center justify-center px-4 pt-3 pb-4 text-center md:pt-5 md:pb-6">
            ...
            <div className="bg-[#1a1a1a] rounded-2xl border border-gray-800 overflow-hidden shadow-lg">
              ...
              <div className="p-4 md:p-6">
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#0f0f0f] border border-gray-700 rounded-lg text-gray-100 placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors text-sm md:text-base"
    ...
    <>
      <main className="flex-1 overflow-auto">
        <div className="max-w-7xl mx-auto p-4 md:p-8">
          <div className="mb-8">
            <h1 className="text-2xl md:text-3xl font-bold bg-linear-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent mb-2">
          ...
          <div className="mb-8 border-b border-gray-700">
            <nav className="grid grid-cols-1 gap-2 sm:grid-cols-3">
              <button
                ...
                className={`cursor-pointer text-sm font-medium transition-all border-b-2 flex items-center justify-center gap-2 rounded-t-xl px-4 py-3 sm:rounded-b-none sm:rounded-t-xl md:px-6 md:py-4 ${
                  activeTab === 0
                    ? "text-blue-400 border-blue-400 bg-[#121212]"
                    : "text-gray-400 border-transparent hover:text-gray-300 bg-[#1a1a1a]"
                }`}
              >
